...
- 🎓 **Formación:** Estudiante de la Licenciatura en Inteligencia Artificial y Ciencia de los Datos en **CUGDL (Universidad de Guadalajara)**.
- 📊 **Enfoque analítico:** Especial interés en **Análisis de Datos general y Analítica Deportiva (Sports Analytics)**, identificando patrones y métricas de rendimiento.
...
#### **Manipulación & Limpieza de Datos**
...
![AI Agents & Automation](https://img.shields.io/badge/AI_Agents-Data_Workflows-8E44AD?style=for-the-badge&logo=openai&logoColor=white)
...
* 🎓 **[Certificado Profesional de Análisis de Datos de Google](https://coursera.org/share/f080234e1894bde5f2c8205c8bec412e)** — *Google en Coursera*  
  Especialización práctica en ciclo de vida del dato, limpieza, análisis exploratorio, SQL, visualización y metodologías analíticas.
